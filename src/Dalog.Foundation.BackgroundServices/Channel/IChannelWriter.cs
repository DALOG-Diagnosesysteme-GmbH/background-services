...
/// <summary>
/// Defines a writer for enqueuing items of type <typeparamref name="TMessage"/> into a channel.
...
/// </typeparam>
public interface IChannelWriter<in TMessage>
{
    /// <summary>
    /// Enqueues a single item of type <typeparamref name="TMessage"/> into the channel asynchronously.
    ...
    /// </returns>
    ValueTask Enqueue(TMessage item, CancellationToken cancellationToken = default);

    /// <summary>
    /// Enqueues a range of items of type <typeparamref name="TMessage"/> into the channel asynchronously.
    ...
    /// </returns>
    ValueTask EnqueueRange(IEnumerable<TMessage> item, CancellationToken cancellationToken = default);
}
